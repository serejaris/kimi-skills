...
Titles use a Georgia-class serif typeface; body text, charts, tables, and annotations use a Tahoma-class sans-serif typeface. A small amount of Gill Sans may serve only as a special brand accent, not replacing the main system.
