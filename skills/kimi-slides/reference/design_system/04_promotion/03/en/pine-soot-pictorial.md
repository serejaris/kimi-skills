...
Use sans-serif fonts. Body text centers on ArialUnicodeMS, titles use Arial-Black extensively, and navigation/some small text uses LiberationSans. When replicating, pair an ultra-heavy black sans with a regular sans-serif; small navigation uses narrow letterspacing / all-caps.
