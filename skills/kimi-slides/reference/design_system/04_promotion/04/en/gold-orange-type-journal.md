...
The Helvetica Now family of modern sans-serifs forms the skeleton, combined with giant bold titles, high black-white contrast, full-bleed case images, restrained footers, and per-page theme colors.
...
- **Typographic character**: the Helvetica Now family is the core; bold Display for titles, Text Regular for body, Text Bold/Micro Bold for subheadings, footers, and labels. Small amounts of serif or handwriting/experimental fonts appear only as case content itself — never as report-wide fonts.
