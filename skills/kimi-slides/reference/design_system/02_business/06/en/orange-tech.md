...
A modern sans-serif business style, with LiberationSans and ArialUnicodeMS as the main body, small amounts of Arial-Black for subtitles/emphasis labels, and small amounts of light and italic faces for the cover or quotations. For Chinese, choose geometric or neutral sans-serifs; avoid calligraphic, handwritten, and strongly decorative fonts.
...
- **Content-page titles:** approx. 2.5–3.5x body text, upper-left aligned, medium-to-light weight, no thick strokes.
- **Key information numbers:** approx. 2–3x body text, may be slightly smaller than the title or on par, with small unit/note text.
- **Subtitles/card titles:** approx. 1–1.2x body text, may be bolded or carry an Arial-Black temperament; keep them short.
