...
The whole deck is a 16:9 landscape canvas; content pages use a near-black background with white modern sans-serif bold titles, body and footnotes in Geist/Inter-type sans-serif; the header holds a fixed small brand wordmark; the footer contains the report name, copyright, sources, and page numbers. Main content includes line, column, stacked-column, and area charts, timelines, tables, and text lists/avatar matrices; accent colors are fluorescent green, purple, pink, yellow, and other high-saturation colors.
...
Fonts are modern sans-serif, dominated by Geist-Regular, Geist-Medium, Geist-SemiBold, Geist-Bold, and the Inter family. Do not mix in serif or handwritten fonts; special sponsor/logo fonts exist only as images or marks.
