...
- **Readability over decoration**: black-and-white/grayscale visuals, white-background information areas, and Verdana bold large titles form high contrast; photos, handwriting-style text, badges, and charts must not overpower the text conclusion.
...
- **Logo**: the brand logo is used on identity pages such as the cover and closing page. The closing page is a red background with a centered white logo and a small handwriting-style tagline; the logo is not repeated and enlarged on every page.
...
- **Key message sentences**: handwriting-style text may carry short labels, quote-style slogans, or small group names such as "Best Career for Top Business Talent" or "Results stories," not formal long body text.
- **Body text organization**: left-aligned bullets, 3–5 items per page, each spanning 1–3 lines; keywords are locally bolded with Verdana-Bold, not relying on colored highlighting.
...
For institutional facts, capability scope, or background information. The left side holds a black-and-white or low-saturation photo; the right side, on a white background, holds a handwriting-style small heading and a bullet list, with black body text and bolded key phrases. Suitable for a moderate amount of text; not suitable for complex tables, multiple charts, or too many small icons.
...
For section transitions, thematic emphasis, or value propositions. A large solid-red background, with large white Verdana-Bold text centered or off-center, possibly paired with a large symbol or short phrase. Expresses only one thesis; bullets, long paragraphs, or complex charts must not be layered on.

### D. White-background opinion + red block/photo collage page

For talent vision, culture statements, and emotional expression. A large red title on a white background at the top; below, red rectangular text blocks and black-and-white portrait photos placed side by side. Red blocks carry handwriting-style white text or short phrases; not suitable for fine-grained data explanations.
...
For three categories of results, three challenges, or three types of recognition. Three circular visual objects divided evenly horizontally, with handwriting-style labels at the top; the circles may hold black-and-white photos, red graphic icons, or grayscale portraits. Suitable for up to three items; more than three should switch to a list or grouped wall.

### G. Chart + horizontal emphasis band page

For a small amount of trend data. A short heading-style explanation at the top, with a concise line/area chart as the body, overlaid with a black horizontal band or handwriting-style white-text conclusion. The chart serves as evidence, the band as explanation; do not use when there are too many data series or precise readings are needed.
...
- **Black accent band: #222222 / #2A2A2A**
  - Used for horizontal explanatory bands on chart pages and some photo text overlays, carrying white handwriting-style/conclusion text.
...
- **Font character**: primarily Verdana and Verdana-Bold; a small amount of handwriting-style font is used for emotional labels, not as a body font.
- **Title hierarchy**: main titles use Verdana-Bold, all-caps, about 2.5–4x the body size; red backgrounds use white text, white backgrounds usually use red text; line spacing is tight.
...
- **Body bullets**: body text = 1x, primarily Verdana regular, with key phrases bolded in Verdana-Bold at the same size; bullet markers are simple with shallow indentation.
- **Subheadings/group labels**: handwriting-style font or Verdana-Bold, about 0.9–1.3x the body size; handwriting-style labels must be short.
...
- **Annotation language**: handwriting-style font or white-text horizontal bands may express short conclusions; charts serve as proof, not as the full narrative.
...
- Components: do the red title band, bottom conclusion bar, circular crops, handwriting labels, and black-and-white photos serve information function rather than piling up as decoration.
