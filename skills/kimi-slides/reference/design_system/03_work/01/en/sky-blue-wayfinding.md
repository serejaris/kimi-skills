...
Use Source Han Sans (思源黑体) or PingFang (苹方) for Chinese, and Arial/Helvetica-type sans-serifs for English; numbers, codes, and times may use a monospace font. No more than two font-family roles across the deck.
