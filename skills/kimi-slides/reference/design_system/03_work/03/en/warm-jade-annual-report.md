...
- **Type character**: Caladea-Regular and Tahoma are the mainstays, with Tahoma-Bold for subheadings/section emphasis; the combination can be replicated with a similar serif body face + a humanist sans. The type does not pursue a tech or handwritten feel.
