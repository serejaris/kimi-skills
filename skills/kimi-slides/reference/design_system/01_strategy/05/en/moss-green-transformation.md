...
Stable features: deep gray/deep green full base colors, the TrebuchetMS font system, conclusion-style titles at upper left, large body charts/matrices, short-paragraph interpretation on the right, a tiny source/copyright line at the bottom, thin-line frames, fluorescent-green/teal-green accents, and the AI-portrait visuals on the cover/closing pages.
...
- **Font character**: the whole deck uses TrebuchetMS, with TrebuchetMS-Bold and Italic building hierarchy. Do not mix in serif or handwriting fonts.
...
- Does the type keep the TrebuchetMS character, with hierarchy expressed through relative size, weight, and color?
