...
A modern sans-serif business font. Body text mainly uses ArialUnicodeMS / LiberationSans-class sans-serif; the cover's oversized title uses a heavier Arial-Black style. Overall clean, compact, rational — no handwriting fonts, decorative serif fonts, or cartoon fonts.
