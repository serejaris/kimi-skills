...
- **Font character**: the body uses the Arial family, bold for titles and subheadings, italic for quotes or notes; Trebuchet MS is used sparingly for footnotes/copyright; the cover "Report Name" may use a serif font.
...
- **Body text**: defined as 1x, regular Arial, tight line spacing, left-aligned; avoid centered long paragraphs.
...
A flat, restrained, consulting-report-style tech feel; the brand feel comes from brand green, dark photo banners, the Arial font system, and a rigorous grid — not complex decoration.
