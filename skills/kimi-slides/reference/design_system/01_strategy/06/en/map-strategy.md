...
Chinese uses Source Han Sans (思源黑体) or PingFang (苹方); English uses Arial/Helvetica-class sans-serif; section divider large titles may pair with one line of Georgia-class serif English for an atlas feel, but never mix more than two fonts.

- Cover title: 4–5x body size, bold, at most two lines.
- Page title: 2–2.6x body size, left-aligned.
- Key numbers: 2.5–3.5x body size, monospace or condensed numerals preferred.
- Body text: 1x, short sentences.
- Coordinates, legends, sources: 0.55–0.75x, kept readable.

Numbers, years, and region codes may use a monospace font. No all-caps long sentences, italic long passages, or multi-layer shadows.
