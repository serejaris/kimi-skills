...
- **Font character**: the body mainly uses Arial-family sans-serif; titles, sections, or table-of-contents entries may use Times New Roman-class serif; a small amount of bold Trebuchet is used for special titles or branded text. Overall avoid script, handwriting, and rounded cartoon fonts.
