...
本主题的 golden source 是 22 页瑞士风模板的视觉与结构规范。如平台提供原始参考文件,以参考文件的实际页面用法为准;未提供时,以 `references/swiss-layout-lock.md` 和 `assets/template-swiss.html` 为准。
...
1. 同时打开当前 `template-swiss.html` 或生成页、正在修改的测试 PPT;如果平台提供原始参考 PPT,也同步打开对照。
