...
report_data = {
    "meta": {
        ...
        "market": "china_a",
        "position_accounting": "lot_level",
        "position_accounting_note": None,
...
```python
{
    ...
    "markers": [         # markers (strategy backtest = buy/sell; event study = one event marker per row)
        ...
        {"date": "2024-02-01", "action": "event", "label": "Q1 results beat expectations",
         ...
         "source_url": "https://example.com/q1-2024-earnings"},
        ...
        # source_url is strongly recommended for event studies (news / filing / research-report URL).
    ],
    "series_key": "equity",
    "stroke": "#f23645",
