...
> 从 `glab mr --help` 获取的帮助输出。

## 目录

**最常用命令：**
- [mr approve](#mr-approve) - 批准合并请求
- [mr checkout](#mr-checkout) - 本地检出 MR
- [mr create](#mr-create) - 创建新 MR
- [mr diff](#mr-diff) - 查看 MR 中的变更
- [mr list](#mr-list) - 列出合并请求
- [mr merge](#mr-merge) - 合并/接受 MR
- [mr note](#mr-note) - 为 MR 添加评论
- [mr view](#mr-view) - 显示 MR 详情
